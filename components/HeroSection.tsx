...
const TERMINAL_LINES = [
  ...
  { type: "out", text: "ryusu — AI × Automation Engineer" },
  { type: "cmd", text: "cat skills.txt" },
  { type: "out", text: "[ AI自動化, 広告×テック, MCP, Google Workspace ]" },
  ...
  return (
    <section className="min-h-screen flex flex-col justify-center px-5 pt-24 pb-16 max-w-5xl mx-auto">
      ...
      <motion.div
        ...
        className="mb-10"
      >
        <p className="font-mono text-[#444] text-xs tracking-[0.3em] uppercase mb-4">
          // Portfolio 2025
        </p>
      ...
      >
        ...
        <div className="flex items-center gap-2 px-4 py-3 bg-[#161616] border-b border-[#1e1e1e]">
          ...
          <span className="font-mono text-[#333] text-xs ml-2">
            ryusu — zsh
          </span>
        </div>
